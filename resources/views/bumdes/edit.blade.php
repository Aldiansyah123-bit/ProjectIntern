...
<div class="col-md-12">
    <div class="card card-outline card-primary">
        ...
        <form action="/bumdes/update/{{$bumdes->id}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Name</label>
                                <input name="name" class="form-control" value="{{ $bumdes->name}}">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Address</label>
                                <input name="address" class="form-control" value="{{ $bumdes->address}}">
                                <div class="text-danger">
                                    @error('address')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Latitude</label>
                                <input name="latitude" class="form-control" value="{{ $bumdes->latitude}}">
                                <div class="text-danger">
                                    @error('latitude')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Longitude</label>
                                <input name="longitude" class="form-control" value="{{ $bumdes->longitude}}">
                                <div class="text-danger">
                                    @error('longitude')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Phone Number</label>
                                <input name="phone" class="form-control" value="{{ $bumdes->phone}}">
                                <div class="text-danger">
                                    @error('phone')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                                <img src="{{ asset('avatar')}}/{{ $bumdes->avatar}}" width="300px">
                        </div>
                    </div>

                    <div class="col-sm-6">
                        <div class="form-group">
                                <img src="{{ asset('background')}}/{{ $bumdes->background}}" width="300px">
                        </div>
                    </div>
                </div>
            </div>
